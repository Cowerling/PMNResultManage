(function ($) {
    ...
    $.fn.createDataListTable = function (url, entire) {
        var data_table = $(this);
                ...
                dataSrc: function (result) {
                    ...
                    for (var i =0, length = result.dataRecords.length; i < length; i++) {
                        ...
                        for (j = 0, operation_length = result.dataRecords[i].authorities.length; j < operation_length; j++) {
                            var authority = result.dataRecords[i].authorities[j];
                            var operation_name = "", operation_color_style = "";

                            switch (authority) {
                                case "VIEW":
                                    operation_name = "\u67e5\u9605";
                                    operation_color_style = "label-primary";
                                    break;
                                case "DOWNLOAD":
                                    operation_name = "\u4e0b\u8f7d";
                                    operation_color_style = "label-primary";
                            ...
                            if (operation_name != "" && operation_color_style != "") {
                                result.dataRecords[i].operation +=
                                    "<span class='label table-status " + operation_color_style + "' style='font-size: 100%; margin-right: 3px;'>" +
                                    "<a class='text-white' href='../data/" + authority.toLowerCase() + "/" + result.dataRecords[i].tag + "'>" + operation_name + "</a>" +
                                    "</span>"
                            }
                        }
                    }
