(function ($) {
    ...
    $.createProjectCategory = function (category) {
        let category_name = "\u672a\u77e5";

        switch (category) {
            case "HIGH_SPEED_RAILWAY":
                category_name = "\u9ad8\u901f\u94c1\u8def\u9879\u76ee";
                break;
            case "ORMAL_SPEED_RAILWAY":
                category_name = "\u666e\u901f\u94c1\u8def\u9879\u76ee";
                break;
            case "URBAN_RAILWAY":
                category_name = "\u5e02\u57df\u94c1\u8def\u9879\u76ee";
                break;
            case "URBAN_TRANSIT":
                category_name = "\u57ce\u5e02\u8f68\u9053\u4ea4\u901a\u9879\u76ee";
                break;
            case "HIGHWAY":
                category_name = "\u516c\u8def\u9879\u76ee";
                break;
            case "OTHER":
                category_name = "\u5176\u4ed6\u7c7b\u578b\u9879\u76ee";
                break;
            default:
                break;
        }
